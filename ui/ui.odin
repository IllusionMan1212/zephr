...
box_equip_custom_draw :: proc(box: ^Box, custom_draw: BoxCustomDrawFunctionType, user_data: rawptr) {
...
push_border_color :: #force_inline proc(color: Color) {
...
pop_border_color :: #force_inline proc() {
