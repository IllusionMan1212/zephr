...
Mesh :: struct {
    ...
    morph_tangents_offset: int `fmt:"-"`,
    joint_matrices_buf:    u32 `fmt:"-"`,
    joint_matrices_tex:    TextureId `fmt:"-"`,
    vao:                   u32 `fmt:"-"`,
    vbo:                   u32 `fmt:"-"`,
    ebo:                   u32 `fmt:"-"`,
    morph_weights_buf:     u32 `fmt:"-"`,
    morph_weights_tex:     TextureId `fmt:"-"`,
    obb: OBB `fmt:"-"`,
}
...
Node :: struct {
    ...
    skeleton:              ^Node `fmt:"-"`,
    meshes:                []Mesh,
    transform:             m.mat4 `fmt:"-"`,
    has_transform:         bool `fmt:"-"`,
    world_transform:       m.mat4 `fmt:"-"`,
    scale:                 m.vec3 `fmt:"-"`,
    translation:           m.vec3 `fmt:"-"`,
    rotation:              m.quat `fmt:"-"`,
    children:              []^Node,
    inverse_bind_matrices: []m.mat4 `fmt:"-"`,
}
